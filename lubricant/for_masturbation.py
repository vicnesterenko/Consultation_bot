...
def masturbation():
    ...
    print_options(["Чи будете використовувати іграшки?"],
                  ["1: Так 😈", "2: Ні 🤭"])
    toys = int(input("> "))

    if sex == 1 and toys == 1:
        print('Для мастурбації з мастурбатором рекомендуємо брендовані лубриканти від виробників мастурбаторів\n')
        print('Вони протестили їх і підібрали оптимальні властивості для мастурбації з іграшками\n')
        print('- Лубрикант для мастурбаторів Fleshlube Water\nhttps://lovespace.ua/uk/products/lubrikant-dlya-masturbatorov-fleshlube-water?utm_source=t_bot\n'
    ...
    if sex == 1 and toys == 2:
        print('Крем для мастурбації чудово ковзає і зволожує, не залишає липкості і доглядає за шкірою геніталій\n')
        print('Можемо порекомендувати такі лубриканти\n')
        print('- Крем для мастурбації із запахом шкіри Bucked Smokey Wrangler\nhttps://lovespace.ua/uk/products/krem-dlya-masturbacii-s-zapakhom-kozhi-system-jo-bucked-smokey-wrangler?utm_source=t_bot\n'
