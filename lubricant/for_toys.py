...
# materials = int(input("З якого матеріалу твоя іграшка? 1: Метал, 2: Скло, 3: Силікон, 4: ТПЕ, 5: ПВХ"))
  print_options(["З якого матеріалу твоя іграшка?"], ["1: Метал", "2: Скло", "3: Силікон", "4: ТПЕ", "5: ПВХ"])
  materials = int(input("> "))
  ...
  if materials == 1:
    ...
    print("Скло гіпоалергенний і абсолютно не пористий матеріал, що не вимагає особливого догляду")
    type_of_sex_choice()
  elif materials == 3:
    print("З силіконом сумісні усі лубриканти на водній основі і деякі на гібридній")
    type_of_sex_choice()
  elif materials == 4:
